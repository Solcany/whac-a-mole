...
var app = (function () {
    ...
    const audioPath = "../assets/sound/v2/";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$b, 31, 1, 518);
    			set_style(span, "--fontName", fontName);
    			attr_dev(span, "class", "svelte-6uc0b0");
    			add_location(span, file$b, 32, 1, 540);
    			attr_dev(button, "class", "svelte-6uc0b0");
    			add_location(button, file$b, 30, 0, 485);
    		},
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$b, create_fragment$b, safe_not_equal, { handleClick: 0, text: 1, imgSrc: 2 });
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$a, 16, 0, 244);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$8, 30, 1, 468);
    			attr_dev(div, "class", "main svelte-1ujymu2");
    			add_location(div, file$8, 28, 0, 421);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$4, 75, 0, 1412);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	const writable_props = ["x", "y", "diameter", "value", "activeImgSrc", "activationChance", "audioSrc"];
    	...
    	$$self.$$set = $$props => {
    		...
    		if ("audioSrc" in $$props) $$invalidate(8, audioSrc = $$props.audioSrc);
    	};
    ...
    class Mole extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*audioSrc*/ ctx[8] === undefined && !("audioSrc" in props)) {
    			console.warn("<Mole> was created without expected prop 'audioSrc'");
    		}
    	}
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(audio, file$3, 27, 0, 459);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class AudioPlayer extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*src*/ ctx[0] === undefined && !("src" in props)) {
    			console_1.warn("<AudioPlayer> was created without expected prop 'src'");
    		}
    	}
    ...
    function create_each_block_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(71:1) {#each moles as mole}",
    		ctx
    	});
    ...
    // (74:1) {#each moleTypes as moleType}
    function create_each_block$1(ctx) {
    	let audioplayer;
    	let current;

    	audioplayer = new AudioPlayer({
    			props: { src: /*moleType*/ ctx[7].audioSrc },
    			$$inline: true
    		});
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(74:1) {#each moleTypes as moleType}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 68, 0, 1428);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 78, 3, 1630);
    			add_location(span0, file$1, 79, 3, 1669);
    			attr_dev(span1, "class", "moleScore svelte-1pvcnnj");
    			set_style(span1, "--fontName", fontName);
    			add_location(span1, file$1, 77, 2, 1570);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			create_component(footer.$$.fragment);
    			add_location(div0, file$1, 75, 2, 1527);
    			add_location(div1, file$1, 74, 1, 1519);
    			add_location(nav, file$1, 91, 1, 1946);
    			attr_dev(div2, "class", "main svelte-1pvcnnj");
    			add_location(div2, file$1, 72, 0, 1472);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
