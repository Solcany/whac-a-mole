...
var app = (function () {
    ...
    const audioFadeTick = 0.08;
    const audioResetThresh = 0.1;
    ...
    function create_fragment$8(ctx) {
    	...
    	audiobutton = new AudioButton({
    			props: {
    				clickAction: /*startGame*/ ctx[0],
    				text: "Start",
    				imgSrc: "./assets/image/mole_active_4.png",
    				audioSrc: "../assets/sound/01.mp3"
    			},
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(nav, file$8, 35, 1, 560);
    			attr_dev(div, "class", "main svelte-1ujymu2");
    			add_location(div, file$8, 33, 0, 513);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(audio, file$3, 33, 0, 805);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    				...
    				var resetPlayer = setInterval(
    					function () {
    						if (player.volume > audioResetThresh) {
    							$$invalidate(1, player.volume -= audioFadeTick, player);
    						}
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$1, 78, 3, 1640);
    			add_location(span0, file$1, 79, 3, 1679);
    			attr_dev(span1, "class", "moleScore svelte-1pvcnnj");
    			set_style(span1, "--fontName", fontName);
    			add_location(span1, file$1, 77, 2, 1580);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = space();
    			create_component(footer.$$.fragment);
    			add_location(div0, file$1, 75, 2, 1537);
    			add_location(div1, file$1, 74, 1, 1529);
    			add_location(nav, file$1, 91, 1, 1956);
    			attr_dev(div2, "class", "main svelte-1pvcnnj");
    			add_location(div2, file$1, 72, 0, 1482);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
