...
var app = (function () {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-14dpdmm");
    			add_location(img, file$7, 29, 1, 451);
    			set_style(span, "--fontSize", h2Size);
    			attr_dev(span, "class", "svelte-14dpdmm");
    			add_location(span, file$7, 30, 1, 473);
    			attr_dev(button, "class", "svelte-14dpdmm");
    			add_location(button, file$7, 28, 0, 418);
    		},
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ h2Size, handleClick, text, imgSrc });
    ...
    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$7, create_fragment$7, safe_not_equal, { handleClick: 0, text: 1, imgSrc: 2 });
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t2 = space();
    			p = element("p");
    			t3 = text("Made by Matúš Solčány in 2021. ");
    			a = element("a");
    			a.textContent = "Code";
    			set_style(h1, "--fontSize", h1Size);
    			attr_dev(h1, "class", "svelte-naipu1");
    			add_location(h1, file$6, 45, 0, 691);
    			attr_dev(nav, "class", "svelte-naipu1");
    			add_location(nav, file$6, 46, 0, 745);
    			attr_dev(a, "href", "https://github.com/Solcany/whac-a-mole");
    			attr_dev(a, "class", "svelte-naipu1");
    			add_location(a, file$6, 49, 34, 883);
    			attr_dev(p, "class", "svelte-naipu1");
    			add_location(p, file$6, 49, 0, 849);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Button, h1Size, gameState, startGame });
    	return [startGame];
    }
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$5, 30, 1, 588);
    			attr_dev(div1, "class", "progressContainer svelte-6zlrub");
    			add_location(div1, file$5, 29, 0, 555);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*liveScore*/ 1) set_data_dev(t, /*liveScore*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    		d: function destroy(detaching) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ gameScore, liveScore, $gameScore });
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$gameScore*/ 2) {
    			$$invalidate(0, liveScore = $gameScore.reduce((v, acc) => v + acc));
    		}
    	};
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(63:1) {#each moles as mole}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 60, 0, 1088);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text(/*$gameScore*/ ctx[0]);
    			t4 = space();
    			nav = element("nav");
    			create_component(button0.$$.fragment);
    			t5 = space();
    			create_component(button1.$$.fragment);
    			set_style(h1, "--fontSize", h2Size);
    			attr_dev(h1, "class", "svelte-1jas3im");
    			add_location(h1, file$1, 38, 1, 595);
    			set_style(h2, "--fontSize", h1Size);
    			attr_dev(h2, "class", "svelte-1jas3im");
    			add_location(h2, file$1, 39, 1, 649);
    			add_location(div, file$1, 37, 0, 588);
    			add_location(nav, file$1, 41, 0, 723);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*$gameScore*/ 1) set_data_dev(t3, /*$gameScore*/ ctx[0]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_if_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(42:2) {#if $gameState == \\\"gameStart\\\"}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "svelte-12osbzj");
    			add_location(section, file, 40, 0, 762);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
