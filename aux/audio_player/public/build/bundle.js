...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(audio, file$1, 25, 1, 258);
    			add_location(div, file$1, 24, 0, 251);
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, src, key, player, handleKeyDown });
    	...
    	return [src, player, handleKeyDown, key, audio_binding];
    }

    class AudioPlayer extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { src: 0, key: 3 });
    		...
    		if (/*key*/ ctx[3] === undefined && !("key" in props)) {
    			console.warn("<AudioPlayer> was created without expected prop 'key'");
    		}
    	}
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file, 19, 0, 389);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const data = tracks.map(function (track, i) {
    		return { track, key: keys[i] };
    	});
    	...
    	$$self.$capture_state = () => ({ AudioPlayer, tracks, keys, data });
    	return [data];
    }
